...
use Squall\Facebook\HttpClients\FacebookHttpable;
use Squall\Facebook\HttpClients\FacebookCurlHttpClient;
use Squall\Facebook\HttpClients\FacebookStreamHttpClient;
...
class FacebookRequest
{
   ...
   * handler
   *
   * @param \HttpClients\FacebookHttpable
   */
