 ...
 * shall be included in all copies or substantial portios of the software.
 *
...
use Squall\Facebook\Entities\AccessToken;
use Squall\Facebook\Entities\SignedRequest;
